...
class LoaiKhoaHocSeeding extends Seeder
{
    public function run(): void
    {
        ...
        DB::table('loai_khoa_hocs')->insert([
            [
                'ten_khoa_hoc' => 'Fullstack Node.js',
                ...
                'tinh_trang' => 1,
                'link_gioi_thieu' => 'https://www.youtube.com/embed/ysjJlvQ3FFc?si=qdHDOSzzXc1rIdWo',
                'gia_goc' => 2000000,
                'gia_ban' => 1500000,
                'created_at' => Carbon::createFromTimestamp(rand($startDate->timestamp, $endDate->timestamp)),
            ],
            [
                'ten_khoa_hoc' => 'Java Script',
                'slug_khoa_hoc' => 'java-script',
                'hinh_anh' => 'https://blog.haposoft.com/content/images/2022/01/cafedev_javascript.png',
                'mo_ta_ngan' => 'JavaScript, theo phiên bản hiện hành, là một ngôn ngữ lập trình được phát triển từ các ý niệm nguyên mẫu. Ngôn ngữ này được dùng rộng rãi cho các trang web cũng như phía máy chủ.',
                'tinh_trang' => 1,
                'link_gioi_thieu' => 'https://www.youtube.com/embed/Ko3jE3HNtFw?si=MvekV_-nW00nFbzW',
                'gia_goc' => 12000,
                'gia_ban' => 6000,
                'created_at' => Carbon::createFromTimestamp(rand($startDate->timestamp, $endDate->timestamp)),
            ],
            [
                ...
                'hinh_anh' => 'https://encrypted-tbn0.gstatic.com/images?q=tbn:ANd9GcTSoW3g9hjXIasgon-kpzz-lD9z4SsalyPbZA&s',
                ...
                'tinh_trang' => 1,
                'link_gioi_thieu' => 'https://www.youtube.com/embed/x0fSBAgBrOQ?si=VHVNF4nziw-QLZAv',
                'gia_goc' => 2500000,
                'gia_ban' => 2000000,
                'created_at' => Carbon::createFromTimestamp(rand($startDate->timestamp, $endDate->timestamp)),
            ],
            [
                ...
                'tinh_trang' => 1,
                'link_gioi_thieu' => 'https://www.youtube.com/embed/EwCayHW3O50?si=V1t4Q-wTjfoOb388',
                'gia_goc' => 1800000,
                'gia_ban' => 1200000,
                'created_at' => Carbon::createFromTimestamp(rand($startDate->timestamp, $endDate->timestamp)),
            ],
            [
                ...
                'tinh_trang' => 1,
                'link_gioi_thieu' => 'https://www.youtube.com/embed/dDajeR6l6UE?si=YAZoIh5bwq1tmNPG',
                'gia_goc' => 3000000,
                'gia_ban' => 2500000,
                'created_at' => Carbon::createFromTimestamp(rand($startDate->timestamp, $endDate->timestamp)),
            ],
            [
                ...
                'tinh_trang' => 1,
                'link_gioi_thieu' => 'https://www.youtube.com/embed/u-XGOrHBB1c?si=Uy5VCxKhwng7HzGc',
                'gia_goc' => 10000,
                'gia_ban' => 5000,
                'created_at' => Carbon::createFromTimestamp(rand($startDate->timestamp, $endDate->timestamp)),
            ],
            [
                ...
                'tinh_trang' => 1,
                'link_gioi_thieu' => 'https://www.youtube.com/embed/gQVWGj3h1pM?si=eUWb5a4tQZhUbnjH',
                'gia_goc' => 2500000,
                'gia_ban' => 2000000,
                'created_at' => Carbon::createFromTimestamp(rand($startDate->timestamp, $endDate->timestamp)),
            ],
            [
                ...
                'tinh_trang' => 1,
                'link_gioi_thieu' => 'https://www.youtube.com/embed/CDLQOWh0TmQ?si=anSYUm0VwejOCrl-',
                'gia_goc' => 2600000,
                'gia_ban' => 2300000,
                'created_at' => Carbon::createFromTimestamp(rand($startDate->timestamp, $endDate->timestamp)),
            ],
            [
                ...
                'tinh_trang' => 1,
                'link_gioi_thieu' => 'https://www.youtube.com/embed/ADg3VdITIVs?si=XJ-0vPLKigIoQHVd',
                'gia_goc' => 1800000,
                'gia_ban' => 1000000,
                'created_at' => Carbon::createFromTimestamp(rand($startDate->timestamp, $endDate->timestamp)),
            ],
            [
                ...
                'tinh_trang' => 1,
                'link_gioi_thieu' => 'https://www.youtube.com/embed/oUvTfcMSbqw?si=KdBCVsM3yxtIVa20',
                'gia_goc' => 2800000,
                'gia_ban' => 2500000,
                'created_at' => Carbon::createFromTimestamp(rand($startDate->timestamp, $endDate->timestamp)),
            ],
            [
                ...
                'tinh_trang' => 1,
                'link_gioi_thieu' => 'https://www.youtube.com/embed/1z41xdD2NfE?si=tOdkSC7FwhzZvV0G',
                'gia_goc' => 3000000,
                'gia_ban' => 2700000,
                'created_at' => Carbon::createFromTimestamp(rand($startDate->timestamp, $endDate->timestamp)),
            ],
            [
                ...
                'tinh_trang' => 1,
                'link_gioi_thieu' => 'https://www.youtube.com/embed/EDIDYkzcZSA?si=8uVnUaK1kJW7QBE3',
                'gia_goc' => 2200000,
                'gia_ban' => 2000000,
                'created_at' => Carbon::createFromTimestamp(rand($startDate->timestamp, $endDate->timestamp)),
            ],
            [
                ...
                'tinh_trang' => 1,
                'link_gioi_thieu' => 'https://www.youtube.com/embed/v05PGrRUeVo?si=wE75JETf1mvc_Z1M',
                'gia_goc' => 2400000,
                'gia_ban' => 1900000,
                'created_at' => Carbon::createFromTimestamp(rand($startDate->timestamp, $endDate->timestamp)),
            ],
            [
                ...
                'tinh_trang' => 1,
                'link_gioi_thieu' => 'https://www.youtube.com/embed/WqlaUrfvRE8?si=P_P4AWn5gE5F_9_5',
                'gia_goc' => 1500000,
                'gia_ban' => 1200000,
                'created_at' => Carbon::createFromTimestamp(rand($startDate->timestamp, $endDate->timestamp)),
            ],
            [
                ...
                'tinh_trang' => 1,
                'link_gioi_thieu' => 'https://www.youtube.com/embed/kQRpe1HkALE?si=Frv5cuAtcrRAMQQm',
                'gia_goc' => 2100000,
                'gia_ban' => 1800000,
                'created_at' => Carbon::createFromTimestamp(rand($startDate->timestamp, $endDate->timestamp)),
            ],
            [
                ...
                'tinh_trang' => 1,
                'link_gioi_thieu' => 'https://www.youtube.com/embed/AEptYkblFg8?si=gWwjQrRlnMXNYKj0',
                'gia_goc' => 2400000,
                'gia_ban' => 2000000,
                'created_at' => Carbon::createFromTimestamp(rand($startDate->timestamp, $endDate->timestamp)),
            ],
            [
                ...
                'tinh_trang' => 1,
                'link_gioi_thieu' => 'https://www.youtube.com/embed/th1iIiiUXdc?si=Ama6VzxmE2WpnpUS',
                'gia_goc' => 3000000,
                'gia_ban' => 2500000,
                'created_at' => Carbon::createFromTimestamp(rand($startDate->timestamp, $endDate->timestamp)),
            ],
            [
                ...
                'tinh_trang' => 1,
                'link_gioi_thieu' => 'https://www.youtube.com/embed/yXUMvyr6n3Y?si=cFl4kuBMxikFQ7p',
                'gia_goc' => 2700000,
                'gia_ban' => 2400000,
                'created_at' => Carbon::createFromTimestamp(rand($startDate->timestamp, $endDate->timestamp)),
            ],
            [
                ...
                'tinh_trang' => 1,
                'link_gioi_thieu' => 'https://www.youtube.com/embed/b_mKpQIDSGs?si=FQjj7YiLW5zrHKBK',
                'gia_goc' => 2000000,
                'gia_ban' => 1700000,
                'created_at' => Carbon::createFromTimestamp(rand($startDate->timestamp, $endDate->timestamp)),
            ],
            [
                ...
                'tinh_trang' => 1,
                'link_gioi_thieu' => 'https://www.youtube.com/embed/IPDzCm8Df-g?si=f5AHbPwaKk4ZF0yf',
                'gia_goc' => 3000000,
                'gia_ban' => 2700000,
                'created_at' => Carbon::createFromTimestamp(rand($startDate->timestamp, $endDate->timestamp)),
            ],
            [
                ...
                'tinh_trang' => 1,
                'link_gioi_thieu' => 'https://www.youtube.com/embed/8-N1uExed_0?si=O8RG3Bm5U9nfOxxo',
                'gia_goc' => 2200000,
                'gia_ban' => 1900000,
                'created_at' => Carbon::createFromTimestamp(rand($startDate->timestamp, $endDate->timestamp)),
            ],
